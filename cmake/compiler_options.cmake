...
elseif(HAS_CXX17_FLAG)
    ...
    message(FATAL_ERROR "C++17 standard is required!")
endif()
...
if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    ...
    if(GCC_VERSION VERSION_LESS 7.1)
        message(FATAL_ERROR "Minimum required version of g++ for C++17 support is 7.1")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    if(CLANG_VERSION VERSION_LESS 5.0)
        message(FATAL_ERROR "Minimum required version of clang for C++17 support is 5.0")
    endif()
    message(STATUS "Using clang version ${CLANG_VERSION}")
elseif(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.14)
        message(FATAL_ERROR "Minimum required version of MSVC for C++17 support is 19.14 (Visual Studio 2017 version 15.7)")
    endif()
